...
class Post_Custom_Field extends Tag {
	...
	public function get_name() {
		return 'repeaterly-post-custom-field';
	}

	public function get_title() {
		return esc_html__( 'Post Custom Field', 'repeaterly' );
	}
	...
	protected function register_controls() {
		$this->add_control(
			'key',
			[
				'label' => esc_html__( 'Key', 'repeaterly' ),
		...
		$this->add_control(
			'custom_key',
			[
				'label' => esc_html__( 'Custom Key', 'repeaterly' ),
